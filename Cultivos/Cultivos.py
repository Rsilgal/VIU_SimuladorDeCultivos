class Cultivos():
    ...
    def dias_transcurridos(self, factorDecremento = 1): #Método mediante el cual restaremos la cantidad de días deseada a los cultivos. Por defecto, el decremento de días será 1.
